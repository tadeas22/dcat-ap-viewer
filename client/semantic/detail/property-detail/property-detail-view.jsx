...
import {fetchPropertyDetail, onPropertyDetailUnmount} from "./property-detail-action";
import {dataSelector} from "./property-detail-reducer";
...
class _PropertyDetail extends React.Component {
...
const mapDispatchToProps = (dispatch, ownProps) => ({
    "fetch": () => dispatch(fetchPropertyDetail(ownProps.iri)),
    "unmount": () => dispatch(onPropertyDetailUnmount)
});
